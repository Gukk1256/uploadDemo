...
<!-- Slideshow -->
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-items set-bg" data-setbg="/forUser/img/1246.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>Bag,kids</span>
            ...
            <div class="single-hero-items set-bg" data-setbg="/forUser/img/1248.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>Bag,kids</span>
            ...
            <div class="single-hero-items set-bg" data-setbg="/forUser/img/1636.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                           <!--  <span>Bag,kids</span> -->
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="/forUser/img/banner-1.jpg" alt="">
                ...
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="/forUser/img/banner-2.jpg" alt="">
                        <div class="inner-text">
                            <h4>Women</h4>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="/forUser/img/banner-3.jpg" alt="">
                        <div class="inner-text">
                            <h4>Kid</h4>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="product-large set-bg" data-setbg="/forUser/img/products/women-large.jpg">
                        <h2>Women</h2>
                        <a href="/home/brand?field1=0000">Discover More</a>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="product-large set-bg m-large" data-setbg="/forUser/img/products/man-large.jpg">
                        <h2>Men</h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="/forUser/img/latest-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="/forUser/img/latest-2.jpg" alt="">
                        <div class="latest-text">
                            <div class="tag-list">
                                <div class="tag-item">
                                    <i class="fa fa-calendar-o"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="/forUser/img/latest-3.jpg" alt="">
                        <div class="latest-text">
                            <div class="tag-list">
                                <div class="tag-item">
                                    <i class="fa fa-calendar-o"></i>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-benefit">
                            <div class="sb-icon">
                                <img src="/forUser/img/icon-1.png" alt="">
                            </div>
                            <div class="sb-text">
                                <h6>Free Shipping</h6>
                    ...
                    <div class="col-lg-4">
                        <div class="single-benefit">
                            <div class="sb-icon">
                                <img src="/forUser/img/icon-2.png" alt="">
                            </div>
                            <div class="sb-text">
